...
'nl': dict(
    ...
    hero_eyebrow='Verhalen, kennis en betekenis onderweg',
    hero_lede='Onderweg vertelt 2R wat landschap, geschiedenis en mensen met elkaar verbindt. Luister spontaan waar je ook gaat, of volg een zorgvuldig samengestelde luisterroute — te voet, op de fiets, in de trein of in de auto.',
...
'en': dict(
    ...
    hero_eyebrow='Stories, knowledge and meaning along the way',
    hero_lede='Along the way, 2R reveals how landscape, history and people connect. Listen spontaneously wherever you go, or follow a carefully composed audio route — on foot, by bicycle, by train or by car.',
...
'de': dict(
    ...
    hero_eyebrow='Geschichten, Wissen und Bedeutung unterwegs',
    hero_lede='Unterwegs erzählt 2R, wie Landschaft, Geschichte und Menschen miteinander verbunden sind. Höre spontan, wohin du auch gehst, oder folge einer sorgfältig komponierten Hörroute — zu Fuß, mit dem Fahrrad, mit der Bahn oder mit dem Auto.',
...
'fr': dict(
    ...
    hero_eyebrow='Histoires, savoir et sens en chemin',
    hero_lede='En chemin, 2R raconte ce qui relie les paysages, l’histoire et les gens. Écoutez spontanément où que vous alliez, ou suivez un parcours audio soigneusement composé — à pied, à vélo, en train ou en voiture.',
...
'es': dict(
    ...
    hero_eyebrow='Historias, conocimiento y significado durante el viaje',
    hero_lede='Durante el viaje, 2R cuenta cómo se conectan el paisaje, la historia y las personas. Escucha historias espontáneas allí donde vayas o sigue una ruta sonora cuidadosamente elaborada — a pie, en bicicleta, en tren o en coche.',
...
'pt': dict(
    ...
    hero_eyebrow='Histórias, conhecimento e significado pelo caminho',
    hero_lede='Ao longo da viagem, o 2R conta como a paisagem, a história e as pessoas se ligam. Ouça espontaneamente onde quer que vá ou siga uma rota sonora cuidadosamente composta — a pé, de bicicleta, de comboio ou de carro.',
...
HOWTO_IMAGES = ['2r-zo-werkt-het-hero-v1.jpg', '2r-howto-reiskeuze-v1.webp', '2r-howto-verhaal-v1.webp', '2r-roadmap-horizon-v1.webp', '2r-howto-ritme-v1.webp']
