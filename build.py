...
'nl': dict(
    ...
    hero_lede='Of je nu wandelt, fietst, met de trein of met de auto reist: je navigatie wijst je de weg — <b>2 Route</b> vertelt het verhaal van die weg, spontaan of als zorgvuldig opgebouwd routeboek.',
...
'en': dict(
    ...
    hero_lede="Whether you walk, cycle, travel by train or by car: your navigation shows you the road — <b>2 Route</b> tells the story of that road, spontaneously or as a carefully built route book.",
...
'de': dict(
    ...
    hero_lede='Ob du wanderst, radelst, mit der Bahn oder mit dem Auto reist: Deine Navigation zeigt dir den Weg — <b>2 Route</b> erzählt die Geschichte dieses Weges, spontan oder als sorgfältig aufgebautes Routenbuch.',
...
'fr': dict(
    ...
    hero_lede="Que vous marchiez, pédaliez, voyagiez en train ou en voiture : votre navigation vous montre la route — <b>2 Route</b> raconte l'histoire de cette route, spontanément ou en carnet de route soigneusement composé.",
...
'es': dict(
    ...
    hero_lede='Camines, pedalees, viajes en tren o en coche: tu navegador te indica el camino — <b>2 Route</b> cuenta la historia de ese camino, de forma espontánea o como un libro de ruta cuidadosamente construido.',
...
'pt': dict(
    ...
    hero_lede='Caminhando, pedalando, de comboio ou de carro: seu navegador mostra o caminho — <b>2 Route</b> conta a história desse caminho, de forma espontânea ou como um livro de rota cuidadosamente construído.',
